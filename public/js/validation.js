...
(() => {
/*!***********************************************!*\
  !*** ./resources/js/validation/validation.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
...
document.addEventListener("DOMContentLoaded", function () {
  document.querySelector("form").addEventListener("submit", function (event) {
    ...
    if (!_helpers__WEBPACK_IMPORTED_MODULE_0__.nameRegex.test(firstName) || !_helpers__WEBPACK_IMPORTED_MODULE_0__.nameRegex.test(lastName)) {
    ...
    for (var i = 0; i < numbers.length; i++) {
      if (!(0,_helpers__WEBPACK_IMPORTED_MODULE_0__.isValidPhoneNumber)(numbers[i].value)) {
